...
if __name__ == '__main__':
    ...
    # Semi Train Data Feature Extraction
    ...
    addCharTagProb(semiTrainDF, 'semiTrain-BIEonly-addTSN-addSubstringTag-addResultCount')
    # Add New Feature

    # xgbTrain
    xgbTrainAndValid('semiTrain-BIEonly-addTSN-addSubstringTag-addResultCount-addCharTagProb')
    # xgbTrain

    # Semi Test Data Feature Extraction
    ...
    addCharTagProbForTest(semiTrainDF, 'semiTrain-BIEonly-addTSN-addSubstringTag-addResultCount')
    # Add New Feature

    # Test Data Predict
    data = 'BIEonly-addTSN-addSubstringTag-addResultCount-addCharTagProb'
